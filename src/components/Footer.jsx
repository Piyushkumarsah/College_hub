...
export default function () {
    ...
    return (
        <div className=' bg-slate-950 h-[450px]  text-white' >
            <div className='mx-12 pt-12 h-full items-center flex flex-col justify-end'>
                <div className='flex flex-col md:flex-row  w-full h-full' style={{ fontfamily: "'Inter', sans-serif" }}>
                    <div className='flex flex-col mt-3 w-full'>
                        ...
                        {
                            values1.map(key => (
                                <div className='text-slate-400 pt-2 ' style={{ fontFamily: "'Diphylleia', 'serif'" }}>
                                    {key}
                                </div>
                            ))
                        }
                    ...
                    <div className='flex flex-col mt-3 w-full '>
                        <h1 className='font-bold text-2xl pt-2' >Locations and Social Handles :-</h1>
                ...
                <h1 className='inline border mb-10 text-6xl' style={{fontFamily: "'Protest Revolution', sans-serif"}}>College_<span className='text-orange-400'>HUb</span></h1>
